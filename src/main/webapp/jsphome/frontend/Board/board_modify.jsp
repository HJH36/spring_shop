	    ...
	    <table class="table table-bordered" >
	        <tr>
	            ...
	            <td style="width:80%; text-align:center;">
	                <input class = "form-control" type="text" style="width:350px;max-width: 350px;" name="board_title" id="board_title" value="<%=board_title%>">
	            </td>
	        </tr>
	        ...
	        <tr>
	            ...
	            <td style="width:80%">
	            	...
	            	<script type="text/javascript" src="/jsphome/frontend/Scripts/SE/js/HuskyEZCreator.js" charset="utf-8"></script>
