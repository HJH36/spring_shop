	...
	<div class="container">
	    ...
	    <table class="table table-bordered">
	        <tr>
	            ...
	            <td style="width:80%">
	                <input class = "form-control" type="text" style="width:350px;max-width: 350px;" name="faq_title" id="faq_title" value = "<%=(String)faq_info.get("faq_title")%>">
	            </td>
	        </tr>
	        ...
	        <tr>
	            ...
	            <td style="width:80%">
	            	...
	            	<textarea name="faq_contents" id="faq_contents" style="width:100%;height:300px;display:none;"><%=(String)faq_info.get("faq_contents") %></textarea>
...
<script>
	...
	function send_modify(){
		...
		obj.action="/faq_backend_modify_ok.do";
		obj.submit();
