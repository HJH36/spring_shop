...
<body>
 	...
 	<div class="container">
	   ...
	   <span style="font-size:20px;font-weight:700;">회원 정보 수정</span>
	    
	    <form name="WriteForm" method="POST">
	    <table class="table table-bordered" style="width: 100%;">
	        <tr>
	            <td style="width: 20%; font-weight:900; background-color:ivory; vertical-align:middle;">회원 아이디</td>
	            <td style="width:80%">
...
<script>
	...
	function send_view(){
		 ...
		 obj.action = "/member_backend_default.do";
		 obj.submit();
	}
    ...
    function send_modify(){
        ...
        if(ans){
            obj.action="/member_backend_modify_ok.do";
            obj.submit();
        }else{
        	return false;
        }
