...
<body>
	...
	<div class="container">
	    ...
	    <span style="font-size:20px;font-weight:700;">관리자 정보</span>
	    <table  class="table table-bordered" style="width:100%;">
	        <tr>
	            <td style="width: 20%; font-weight:900; background-color:ivory;">관리자 아이디</td>
	            <td style="width:80%">
	            	<%=member_id %>
	            </td>
	        </tr>
	        ...
	        <tr>
	            <td style="width: 20%; font-weight:900; background-color:ivory;">관리자 종류</td>
	            <td style="width:80%">
...
<!--	    <button class="btn btn-default btn-sm" type="button" onclick="send_pwd('<%=member_idx%>','<%=current_page%>');">비밀번호 변경</button>  -->	
		    <button class="btn btn-default btn-sm" type="button" onclick="location.href='/backend/'">홈</button>
	    </div>
...
<script>
    ...
    function send_modify(member_idx, current_page){
    	location.href="/admin_backend_modify_default.do?member_idx="+member_idx+"&current_page="+current_page;
    }
	
    //회원 비밀변호 변경
    function send_pwd(member_idx, current_page){
    	location.href="/admin_backend_pwd_default.do?member_idx="+member_idx+"&current_page="+current_page;
    }
