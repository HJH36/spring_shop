...
<body>
	...
	<div class="container">
	    ...
	    <div class="text-center">
		    ...
		    <input type="hidden" name="member_idx" value="<%=author_idx %>">
	    </div>
...
<script>
	...
	function send_modify(){
		...
		obj.action="/board_backend_modify_default.do";
		obj.submit();
	}
	...
	function send_delete(){
		...
		if(ans){
			obj.action="/board_backend_delete_ok.do";
			obj.submit();
		}else{
			return false;
		}
	...
	function send_list(){
		var obj = document.WriteForm;
		obj.action="/board_backend_default.do";
		obj.submit();
	}
