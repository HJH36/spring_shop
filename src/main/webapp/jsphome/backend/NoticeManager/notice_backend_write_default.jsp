	...
	<div class="container">
	    ...
	    <table class="table table-bordered">
	        <tr>
	            ...
	            <td style="width:80%">
	                <input class = "form-control" type="text" style="width:350px;max-width: 350px;" name="notice_title" id="notice_title">
	            </td>
	        </tr>

	        <tr>
	            <td style="width: 20%;">제목 진하게</td>
	            <td style="width:80%">
	        ...
	        <tr>
	            <td style="width: 20%;">탑공지 기간</td>
	            <td style="width:80%">
	            	<input class="form-control input-sm" type="date" name = "notice_edt" id = "notice_edt" style="width:200px;">
	            </td>
	        </tr>
...
<script>
	...
	$(document).ready(function(){
		document.getElementById("notice_edt").vavlue = new Date();
	})
	...
	function send_write(){
		...
		if(obj.notice_edt.value==""){
			alert("탑 공지 날짜를 넣어주세요");
			obj.notice_edt.focus();
			return false;
		}
		
		oEditors.getById["notice_contents"].exec("UPDATE_CONTENTS_FIELD", []);
		
		obj.action="/notice_backend_write_ok.do";
		obj.submit();
	...
	//리스트로 이동
	function send_list(){
		location.href="/notice_backend_default.do";
	}
