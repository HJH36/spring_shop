	        ...
	        <tr>
	            ...
	            <td style="width:80%">
	            	...
	            	<%if(title_check.equals("Y")) {%>
	            		<input type="checkbox" name="title_check" id="title_check" checked disabled> 제목 진하게
	            	<%}else{ %>
	            		<input type="checkbox" name="title_check" id="title_check" disabled> 제목 진하게
	            	<%} %>
	            </td>
	        </tr>
...
<script>
	...
	function send_modify(){
		...
		obj.action="/notice_backend_modify_default.do";
		obj.submit();
	...
	function send_delete(){
		...
		if(ans){
			var obj = document.ModifyForm;
			obj.action="/notice_backend_delete_ok.do";
			obj.submit();
		} else {
			return false;
		}
	...
	function send_list() {
		...
		obj.action = "/notice_backend_default.do";
		obj.submit();
	}
</script>
